...
async function init() {
    ...
    const [baseColorMap, normalMap, maskMap] = await Promise.all([
        viewer.load<ITexture>('https://samples.threepipe.org/textures/Pale_Pink_Carrara_Marble_baseColor.png'),
        viewer.load<ITexture>('https://samples.threepipe.org/textures/Pale_Pink_Carrara_Marble_Normal.png'),
        viewer.load<ITexture>('https://samples.threepipe.org/textures/Pale_Pink_Carrara_Marble_Mask.png'),
    ])
