...
export type {WebGLProgramParametersWithUniforms, WebGLProgramParameters, WebGLCapabilitiesParameters, PixelFormat, PixelFormatGPU, AnyPixelFormat, AnyMapping, WebGLDebug, WebGLRendererParameters, RenderTargetOptions, WebGLLightsState} from 'three'
